    ...
    return knex
        ...
        .createTable('birds', function(birdsTable) {
            ...
            /* Data
               ...
               the chained constraints. For example, in the line below, we
               create a column named `name` which has a maximum length of 250
               characters, is of type string (VARCHAR) and is not nullable. 
             */
